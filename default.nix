{ mkDerivation, aeson, base, bytestring, hipbot, lens, mtl, mueval
, pointfree, pointful, postgresql-simple, process-extras
...
mkDerivation {
  ...
  isExecutable = true;
  buildDepends = [
    aeson base bytestring hipbot lens mtl mueval pointfree pointful
    postgresql-simple process-extras resource-pool safe text
